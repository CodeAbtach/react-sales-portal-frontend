...
/**
 * The base box-shadow styles for the Amazon Sales ReportPRO React.
 * You can add new box-shadow using this file.
 * You can customized the box-shadow for the entire Amazon Sales ReportPRO React using thie file.
 */
